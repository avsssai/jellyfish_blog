...
export default function Home() {
	return (
		<>
			...
			<Layout>
				<Page background='bgBeige' className='min-h-screen flex flex-col mt-24 relative'>
					...
					<div className='scroll-bottom-button md:mt-24 lg:mt-48'>
						<ArrowDownCircle size={96} color='#DE8F85' />
					</div>
				</Page>
				<Page background='bgRedAccent text-bgBeige/90 flex flex-col'>
					<div className='heading font-black text-5xl md:text-7xl font-messina tracking-[-0.10em] leading-[0.9] mt-8 text-bgBeige/90'>
						currently reading
					</div>
					<div className='content flex flex-col lg:flex-row mt-24 max-w-[1200px] self-center'>
						...
						<div className='bookExcerpt flex flex-col flex-1 mb-8 mx-auto px-8 lg:w-[900px] lg:text-xl justify-center'>
							<div className='bookDetails mb-8'>
								<div className='flex flex-col items-center justify-center gap-2'>
									<div className='title text-5xl font-black'>Golden House</div>
							...
							<div className='flex flex-col gap-8 max-w-[500px]'>
								...
								<p>
									...
									where all of the 22 houses are linked connected by their garden hidden away ....Read
									more
								</p>
							</div>
						</div>
				...
				<Page background='bgYello'>
					<div className='heading font-black text-5xl mb-16 font-messina tracking-[-0.10em] leading-[0.9] mt-8 text-bgRed md:text-7xl'>
						More about me
					</div>
					<div className='about flex flex-col gap-8 font-messina max-w-[1200px] text-[32px] md:text-[48px]'>
						<p className='text-black  leading-[1] tracking-[-0.07em] '>
						...
						<p>
							<Link
								...
								className='text-3xl flex items-center  gap-2 underline'>
